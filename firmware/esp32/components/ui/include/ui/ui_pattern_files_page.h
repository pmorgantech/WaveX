...
#include "ui_page.h"
namespace wavex_ui {
class UIPatternFilesPage : public UIPage {
   public:
    const char* name() const override { return "Pattern Files"; }
    const char* contextLine() const override { return "Save / load the working pattern"; }
   ...
   private:
    ...
    WaveX::Protocol::SeqFileStatusMessage status_{};
