...
class UIPadMapPage : public UIPage {
   public:
    explicit UIPadMapPage(bool keyboard = false, uint8_t oscillator = 0, uint16_t assign_sample = 0)
        : keyboard_(keyboard),
          oscillator_(oscillator < 2 ? oscillator : 0),
          assign_sample_(assign_sample) {}
