...
// (__attribute__((packed))) requirements here, these are the canonical
// HAL-free model shared by the scheduler and WXCF pattern codec. Explicit
// field encoders, never native struct copies, define file/wire formats.
//
