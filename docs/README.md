...
| [virtual-analog-filters.md](features/virtual-analog-filters.md) | Research; comparisons unscheduled | TPT/ZDF behavior, self-oscillation/nonlinear models, antialiasing and measured filter-cost polyphony proposal |
